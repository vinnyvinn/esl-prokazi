...
class Users_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        FROM $users_table
        JOIN $team_member_job_info_table ON $team_member_job_info_table.user_id=$users_table.id
    ...
    function get_access_info($user_id = 0) {
        ...
        $sql = "SELECT $users_table.id, $users_table.landing_page, $users_table.user_type, $users_table.user_permissions,$users_table.is_admin,$users_table.location_id, $users_table.role_id, $users_table.email,
        ...
        WHERE $users_table.deleted=0 AND $users_table.id=$user_id";
         return $sq= $this->db->query($sql)->row();
