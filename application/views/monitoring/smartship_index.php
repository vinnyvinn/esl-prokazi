                    ...
                    <table class="table table-striped table-bordered" id="jt" style="width: 100%">
                        ...
                        <?php foreach ($smarts as $smart)  {?>
                            <tr>
                                ...
                                <td><?php echo $smart->id;?></td>
                                <td><a href="<?php echo base_url('monitoring_outages/view_smartship/'.$smart->id)?>" class="btn btn-success btn-xs"><?php echo $smart->location;?></i></a></td>
                                <td><?php echo $smart->start_date;?></td>
                                <td><?php echo $smart->start_time;?></td>
                                <td><?php echo $smart->end_date;?></td>
                                <td><?php echo $smart->end_time;?></td>
                                <td>
                                <?php $start_date=strtotime($smart->start_date);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Smartship Server Form</h4>
                </div>
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url('monitoring_outages/add_smartship');?>">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="text-left">
                                <div class="form-group">
                                    <input type="submit" name="submit" value="Create Smartship Server" class="btn btn-primary">
                                </div>
                            </div>
