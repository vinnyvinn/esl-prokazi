                    ...
                    <table class="table table-striped table-bordered" id="jt" style="width: 100%">
                        ...
                        <?php foreach ($payrolls as $payroll)  {?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('monitoring_outages/view_payroll/'.$payroll->id)?>" class="btn btn-success btn-xs"><?php echo $payroll->location;?></i></a></td>
                                <td><?php echo $payroll->start_date;?></td>
                                <td><?php echo $payroll->start_time;?></td>
                                <td><?php echo $payroll->end_date;?></td>
                                <td><?php echo $payroll->end_time;?></td>
                                <td>
                                    <?php $start_date=strtotime($payroll->start_date);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Payroll Server Form</h4>
                </div>
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url('monitoring_outages/add_payroll');?>">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="text-left">
                                <div class="form-group">
                                    <input type="submit" name="submit" value="Create Payroll Server" class="btn btn-primary">
                                </div>
                            </div>
