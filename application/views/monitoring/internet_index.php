                    ...
                    <table class="table table-striped table-bordered" id="jt" style="width: 100%">
                        ...
                        <?php foreach ($internets as $internet)  {?>
                            <tr>
                                ...
                                <td><?php echo $internet->id;?></td>
                                <td><a href="<?php echo base_url('monitoring_outages/view_internet/'.$internet->id)?>" class="btn btn-success btn-xs"><?php echo $internet->location;?></i></a></td>
                                <td><?php echo $internet->start_date;?></td>
                                <td><?php echo $internet->start_time;?></td>
                                <td><?php echo $internet->end_date;?></td>
                                <td><?php echo $internet->end_time;?></td>
                                <td>
                                    <?php $start_date=strtotime($internet->start_date);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Internet Server Form</h4>
                </div>
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url('monitoring_outages/add_internet');?>">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="text-left">
                                <div class="form-group">
                                    <input type="submit" name="submit" value="Create Internet Server" class="btn btn-primary">
                                </div>
                            </div>
