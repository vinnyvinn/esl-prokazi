...
<ul class="nav nav-tabs vertical" role="tablist">
    ...
    <li role="presentation" class="<?php echo ($active_tab == 'permissions') ? 'active' : ''; ?>"><a href="<?php echo_uri("user_roles"); ?>"><?php echo lang("permissions"); ?></a></li>
    ...
    <li role="presentation" class="<?php echo ($active_tab == 'administration') ? 'active' : ''; ?>"><a href="<?php echo_uri("administration"); ?>">Administration</a></li>
     ...
     <li role="presentation" class="<?php echo ($active_tab == 'departments') ? 'active' : ''; ?>"><a href="<?php echo_uri("departments"); ?>">Departments</a></li>
