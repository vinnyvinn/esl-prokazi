<div class="modal-body clearfix">
    <div id="new-ticket-dropzone" class="post-dropzone">
        ...
        <div class="form-group">
            <label for="location_id" class=" col-md-3">Location</label>
            <div class=" col-md-9">
                <select name="location_id" id="location_id" class="form-control">
                    <option value="<?php echo $location_info->id?>"><?php echo ucfirst($location_info->name);?></option>
                    <?php
                    foreach ($locations as $location) {
                        echo "<option value=". $location->id . ">" . ucfirst($location->name) . "</option>";
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="form-group">
            <label for="ref_user_id" class=" col-md-3">Reference User</label>
            <div class="col-md-9">
                <select name="ref_user_id" id="ref_user_id" class="form-control">
                    <option value="<?php echo $user_info->id?>"><?php echo ucfirst($user_info->first_name) .' '.ucfirst($user_info->last_name);?></option>
                    <?php
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#title").focus();
        $("#ticket-form .select2,#ref_user_id,#location_id").select2();
