                ...
                <span class="dropdown inline-block">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                        ...
                        <?php if ($ticket_info->status === "closed" ) { ?>
                            <li role="presentation" style="display: none"><?php echo ajax_anchor(get_uri("tickets/save_ticket_status/$ticket_info->id/open"), "<i class='fa fa-check-circle'></i> " . lang('mark_as_open'), array("class" => "", "title" => lang('mark_as_open'), "data-reload-on-success" => "1")); ?> </li>
                        <?php } else { ?>
                            ...
                            <?php if($status==1) {?>
                              ...
                              <li role="presentation" style="display: none"><?php echo modal_anchor(get_uri("ticket_types/model_comment"), "<i class='fa fa-check-circle'></i> " . lang('mark_as_closed'), array("class" => "", "title" => 'Add Comment Before Closing', "data-reload-on-success" => "1")); ?> </li>
