...
<?php echo form_open(get_uri("tickets/save_problem"), array("id" => "thirdusers-form", "class" => "general-form", "role" => "form")); ?>
...
echo modal_anchor(get_uri("tickets/thirdparty_form"), "<i class='fa fa-plus-circle'></i>", array("class" => "btn btn-info btn-add", "title" => 'Add User', "data-is-popup" => '1', 'data-populate' => 'add_third_party'));
?>
</div>
    </div>
