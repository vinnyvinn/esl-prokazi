                            ...
                            foreach ($types as $key=>$type){
                                ...
                                <div class="col-md-6 margin-bottom-20">
                                    ...
                                    <div class="fat-content-small padding-left-30">
                                      ...
                                      ?>
                                                <li> <a href="<?php echo base_url('knowledge_base/viewknowledge/'.$knowledge->id) ?>"><i class="fa fa-file-text-o"></i> <?php echo $knowledge->title?></a> </li>
                                                <?php
                                            }
                                            ?>
                                        </ul>
            ...
            <div class="col-md-4 padding-20">
                <div class="row margin-bottom-30">
                    <div class="col-md-12 ">
                        ...
                        <a href="<?php echo base_url('tickets');?>">Create an ICT TICKET</a> for further help.
                        </div>
                    </div>
                </div>
            </div>
