    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            echo form_dropdown("type_id", $types, ($model_info)?$model_info->type_id:'',
                "id='type_id' class='select2 validate-hidden' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploadUrl = "<?php echo get_uri("knowledge_base/upload_file"); ?>";
        var validationUrl = "<?php echo get_uri("knowledge_base/validate_file"); ?>";
