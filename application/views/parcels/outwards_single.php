<div class="panel panel-default">
	<div class="panel panel-heading">Outwards Parcel details</div>
	...
	<div class="row">
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<input type="text" name="from" value="<?php echo $sender->first_name .' '.$sender->last_name;?>" class="form-control" disabled>
			</div>
			<div class="form-group">
				<label for="to">To</label>
				<input type="text" name="to" value="<?php echo $parcels->receiver;?>" class="form-control" disabled>
			</div>
		...
		<div class="col-sm-6">
            ...
            if ($total_files) {
                ...
                echo anchor(get_uri("parcels/download_outward_files/" . $parcels->id), $download_caption, array("class" => "pull-right", "title" => $download_caption));
            }
            ?>
        </div>
			</div>
