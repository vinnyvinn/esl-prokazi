<div class="panel panel-default">
    ...
    <?php if(get_array_value($this->login_user->permissions,"can_send_cheque") =="1") {?>
	...
	<div class="panel panel-body">
        ...
        <th>Actions</th>
          ...
          <td><?php echo $parcel->cheque_no;?></td>
            ...
            <span class="btn btn-success btn-sm">Processing</span></td>
					<td>

						<?php
            if(get_array_value($this->login_user->permissions,"can_assign_cheque_outwards") =="1") {
						if($parcel->status == 0){
                     echo modal_anchor(get_uri("cheques/dispatch_modal/".$parcel->id), "Assign Now", array("class" => "btn btn-danger btn-sm blink_me", "title" => "Inwards Mail or Parcel"));
