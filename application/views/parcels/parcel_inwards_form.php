<?php echo form_open(get_uri("parcels/save_inwards_parcel"), array("id" => "project-form", "class" => "general-form", "role" => "form")); ?>
...
<div class="modal-body clearfix">
   ...
   <input type="hidden" name="id" value="<?php echo $parcel_id?>">
    ...
    <div class="form-group">
        <label for="sender" class=" col-md-3">Sent From(Sender)</label>
        <div class="col-md-8">
