...
<div class="modal-body clearfix">
   ...
   <input type="hidden" name="id" value="<?php echo $dispatch_id?>">

    <div class="form-group">
        <label for="receiver" class=" col-md-3">Receiptionist</label>
        <div class="col-md-8">
          <select class="select2 validate-hidden" name="receptionist_id" id="receptionist_id" required>
              <?php
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
          <input type="text" class="form-control" id="sent_to" name="receiver">
        </div>
