           ...
           <tbody>
            ...
            <tr>
             ...
             <td>
               ...
               <b>Next Service Date: </b> <?php echo $reports_data[0]['next_service_date']?>
       ...
       <table class="table table-striped table-bordered"  style="width: 100%">
         ...
         <tbody>
          ...
          foreach ($parts as $key => $value): ?>
            <tr>
            <td><?= $value ? $value : $reports_data[0]['stock_name'] ?></td>
            <td><?= isset($quantity[$key]) && $quantity[$key]>0 ? number_format((int) $quantity[$key], 0) : $reports_data[0]['qnty_out'] ?></td>
            <td><?= isset($cost[$key]) && $cost[$key]>0 ? number_format((int) $cost[$key], 2) : '' ?></td>
             <td><?= isset($quantity[$key]) && ($quantity[$key]) > 0 ? number_format($quantity[$key] * $cost[$key],2) : $reports_data[0]['totalcost'];
