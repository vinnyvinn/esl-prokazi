 ...
 <form method="POST" action="<?php echo base_url('preventive/save') ?>" enctype="multipart/form-data">
  ...
  <div class="form-group fieldGroup">
    <div class="input-group">
     ...
     <input type="number" name="cost[]" class="form-control" step="0.01" placeholder="Cost">
...
<div class="col-sm-6">
  <div class="form-group">
   ...
   <input type="number" name="labour_cost" class="form-control" step="0.01" placeholder="Labour Cost">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label for="time_in"><b><?php echo lang('time_in'); ?></b></label>
           <input type="text" name="time_in" class="form-control" placeholder="Time in" id="time_in">
        ...
        <div class="col-sm-6">
          ...
          <div id="kilometer" class="services kilometer">
            ...
            <div class="form-group">
              ...
              <input type="text" name="next_service_date" class="form-control" placeholder="Next Service Date" id="next_service_date">
            </div>
          </div>
