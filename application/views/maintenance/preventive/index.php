           ...
           <td><?php echo $asset['job_type_id']?></td>
            <td><?php echo $asset['code']?></td>
             <td><?php echo $asset['driver']?></td>
              ...
              <td>
                  <?php if($asset['status'] == 'In Progress') {?>
                  <a href="<?php echo base_url('preventive/modify_job/'.$asset['id']);?>"  class="btn btn-primary btn-xs"> <i class="fa fa-pencil-square-o"></i></a> ||
                  <a href="<?php echo base_url('preventive/delete_row/'.$asset['id']);?>"  class="btn btn-danger btn-xs"> <i class="fa fa-trash-o"></i></a>
                <?php } ?>
             </td>
             </tr>
       <?php }?>
