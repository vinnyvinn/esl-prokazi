    ...
    <div class="col-sm-12">
        <div class="panel-default">
            <div class="panel-heading">
                ...
                <button class="btn btn-success" onclick="add_trimmer()"
                        style="float: right;margin-top: -26px;margin-right: 100px"><i
                            class="glyphicon glyphicon-plus"></i> <span style="font-size: 12px">Hire Trimmer</span>
                </button>
            </div>
                ...
                <table id="trimmers_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <?php foreach ($trimmer_sheets as $trimmer) { ?>
                        <tr>
                            ...
                            <td><?php echo $trimmer['project']; ?></td>
                            ...
                            <td>
                                <?php if(get_array_value($this->login_user->permissions,'can_edit_trimmer_sheets') == 1) {?>
                                <div class="col-xs-6" style="width: 20%;margin-right: -10px;">
                                    <button class="btn btn-warning edito"
                                            onclick="edit_trimmer(<?php echo $trimmer['id']; ?>)"
                                            style="font-size: 10px;margin-left: -24px !important;"><i
                                                class="glyphicon glyphicon-pencil"></i></button>
                                </div>
                                <?php }?>
                                <?php if(get_array_value($this->login_user->permissions,'can_delete_trimmer_sheets') == 1) {?>
                                <div class="col-xs-6">
                                    <button class="btn btn-danger"
                                            onclick="delete_trimmer(<?php echo $trimmer['id']; ?>)"
                                            style="font-size: 10px"><i class="glyphicon glyphicon-remove"></i></button>
                                </div>
                                <?php }?>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="project_id" placeholder="Project" id="project_id"
                                        required>
                                    <?php
                                    foreach ($projects_dropdown as $project) {
                                        echo "<option value=" . $project->id . ">" . ucfirst($project->name) . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="trimmer" placeholder="Trimmer" id="trimmer_id"
                                        required>
                                    <?php
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3"
                                   for="rate"><b><?php echo lang('start_date'); ?></b></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3"
                                   for="hours"><b><?php echo lang('end_date') ?></b></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="time_in" placeholder="Time In" class="form-control" id="time_in"
                                       type="time">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="time_out" placeholder="Time Out" class="form-control" id="time_out"
                                       type="time">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="delayed_hours" placeholder="Delayed Hours" class="form-control"
                                       id="delayed_hours" type="number">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Delayed Minutes</label>
                            <div class="col-md-9">
                                <input name="delayed_minutes" placeholder="Delayed Minutes" class="form-control"
                                       id="time_out" type="number">
                            </div>
                        </div>
                </form>
            </div>
