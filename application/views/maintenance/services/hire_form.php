      ...
      <table id="hire_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>   
         ...
         <tr>
           ...
           <td><?php echo $hire['equipment'] ? $hire['equipment'] : $hire['asset'] ;?></td>
           <td><?php echo $hire['tonnes'];?></td>
           <td><?php echo $hire['hours'];?></td>
           <td><?php echo $hire['staff'];?></td>
           <td><a href="<?php echo base_url('hire_assets/view_invoice/'.$hire['id'])?>" class="label label-info"><?php echo $hire['supplier'] ? $hire['supplier'] : $hire['supplier_name']?></a>
           </td>
           <td><?php echo $hire['client'] ? $hire['client'] : $hire['client_name'];?></td>
           ...
           <td>
               <?php if(get_array_value($this->login_user->permissions,'can_edit_hired_assets') == 1) {?>
             <div class="col-xs-6" style="width: 20%;margin-right: -10px;">
              <button class="btn btn-warning edito" onclick="edit_asset(<?php echo $hire['id'];?>)" style="font-size: 10px;margin-left: -24px !important;"><i class="glyphicon glyphicon-pencil"></i></button>
               ...
               <?php }?>
               <?php if(get_array_value($this->login_user->permissions,'can_delete_hired_assets') == 1) {?>
            <div class="col-xs-6">                   
    ...
    <div class="modal-dialog">
      <div class="modal-content">
          ...
          <form action="#" id="form" class="form-horizontal">
            ...
            <div class="form-body">
              ...
              <div id="inhouse" class="sources inhouse" style="display: none;">
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <select class="form-control" name="asset_inhouse[]" placeholder="Asset" id="asset_inhouse" multiple>
            ...
            <div id="outsourced" class="sources outsourced">
              <div class="form-group">
                <label class="control-label col-md-3">Asset</label>
                <div class="col-md-9">
                  <select class="form-control" name="asset_outsourced[]" placeholder="Asset" id="asset_outsourced"  multiple="true">

                   <?php
                   foreach ($outsource_dropdown as $outs) {
                    echo "<option value=". $outs->description . ">" . ucfirst($outs->description) . "</option>";
                  }
                  ?>
                </select>
              </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9">
              <input type="checkbox" name="esl_from" id="esl_from"><b> ESL ?</b>
              <input type="text" class="form-control" name="supplier_name" id="supplier_name" value="ESL East Africa">
            <select class="form-control suppl" name="supplier_id" placeholder="supplier" id="supplier_id" required>
      ...
      <div class="form-group">
        <label class="control-label col-md-3">Hire To</label>
            <div class="col-md-9">
            <input type="checkbox" name="esl_to" id="esl_to"> <b> ESL ?</b>
            <input type="text" class="form-control" name="client_name" id="client_name" value="ESL East Africa">
          <select class="form-control clientl" name="client_id" placeholder="Client" id="client_id" required>
