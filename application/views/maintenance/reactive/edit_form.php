...
`
        ...
        <table style="width: 100%">
          ...
          <?php foreach ($parts as $key => $value): ?>
            ...
            <tr>
              <td><?= $value ? $value : $jobs['stock_name']?></td>
              <td><?= isset($quantity[$key]) && $quantity[$key] > 0 ? number_format((int) $quantity[$key], 0) : $jobs['qnty_out'] ?></td>
              <td><?= isset($cost[$key]) && $cost[$key] > 0 ? number_format((int) $cost[$key]*$quantity[$key], 2) : ($jobs['totalcost'] ? $jobs['totalcost']*$jobs['qnty_out']:'')  ?></td>
            </tr>
         ...
         <div class="form-group">
          ...
          <label for="client_id" style="color:#7988a2"><b>Upload Checklist</b>
           <input type='file' name='picture' size='20' class="btn btn-info" id="picture"/>
         </label>
                  <button id="upload" class="btn btn-primary btn-sm" value="checklist" type="submit" style="margin-top: 10px;border-radius: 1px">Save Checklist</button>
    ...
    <div class="col-sm-4">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label for="time_in"><b><?php echo lang('time_in'); ?></b></label>
            ...
            <input type="text" name="time_in" value="<?php echo $jobs['time_in'];?>" class="form-control" disabled>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
          <label for="time_in"><b>Time Out</b></label>
        <input type="text" name="time_out" value="<?php echo $jobs['time_out']?>" class="form-control" disabled>
          
       </div>
      </div>
      <div class="form-group">
          <label for="km_reading"><b>Current Mileage</b></label>

          <?php
          echo form_input(array(
              "id" => "km_reading",
              "name" => "km_reading",
              "value" => $jobs['km_reading'] ? number_format($jobs['km_reading'],2).' km' : ($jobs['miles_reading'] ? number_format(($jobs['miles_reading']),2).' miles' : $jobs['hours'] .' hrs'),
              "class" => "form-control",
              "disabled" => "disabled",
      ...
      <div class="form-group">
        <label for="next_service_date" class="col-sm-8"><b>Next Service Date</b></label>
  ...
  <div class="form-group">
    ...
    <button type="submit" class="btn btn-success" name="submit" value="all_data"><span class="fa fa-check-circle"></span>Close Job Card</button>
