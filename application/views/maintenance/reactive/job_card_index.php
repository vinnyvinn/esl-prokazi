...
<?php }?>
      ...
      <td>
          <?php if($asset['status'] == 'In Progress') {?>
              <a href="<?php echo base_url('preventive/modify_job/'.$asset['id']);?>"  class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-edit"></span> Edit</a> ||
              <a href="<?php echo base_url('preventive/delete_row/'.$asset['id']);?>"  class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> Delete</a>
          <?php } ?>
      </td>
