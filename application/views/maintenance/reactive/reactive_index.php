...
<div class="modal-body clearfix">
    <div class="panel panel-default">
        <div class="panel-heading" style="margin-top: -8px"> Reactive Maintenance Report
            ...
            <?php
            if($job_cards) {
                echo anchor(get_uri("maintenance_report/print_report_r/".$dates['from'].'/'.$dates['to']), "<i class='fa fa-file-pdf-o'></i> " . 'Export Pdf', array("class" => "btn btn-info btn-sm pull-right rq", "title" => lang('print_report')));
                echo anchor(get_uri("maintenance_report/extract_report_r/".$dates['from'].'/'.$dates['to']), "<i class='fa fa-file-excel-o'></i> " . 'Export Excel', array("class" => "btn btn-info btn-sm pull-right rq walla", "title" => lang('print_report'))); }?>
        </div>
    </div>
