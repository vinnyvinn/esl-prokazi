<div class="modal-body">
    <div class="table-responsive mb15">
        ...
        <div class="col-md-12 pb10 ">
            ...
            <?php
            $this->load->view("planner/event_time");
            ?>
        </div>
        <div class="col-md-12">
...
<div class="modal-footer">
    ...
    if (isset($editable) && $editable === "1" && ($this->login_user->id==$model_info->created_by || $this->login_user->is_admin)) {
        ...
        echo modal_anchor(get_uri("global_planner/modal_form"), "<i class='fa fa-pencil'></i> " . lang('edit_event'), array("class" => "btn btn-default", "data-post-encrypted_event_id" => $encrypted_event_id, "title" => lang('edit_event')));
    }
    ?>
    ...
    $(document).ready(function() {
        ...
        $('#delete_event').confirmation({
            ...
            onConfirm: function() {
                ...
                $.ajax({
                    url: "<?php echo get_uri('global_planner/delete') ?>",
                    type: 'POST',
                    dataType: 'json',
