    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("global_planner/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_event'), array("class" => "btn btn-default", "title" => lang('add_event'))); ?>
                <?php echo modal_anchor(get_uri("global_planner/modal_form"), "", array("class" => "hide", "id" => "add_event_hidden", "title" => lang('add_event'))); ?>
                <?php echo modal_anchor(get_uri("global_planner/view"), "", array("class" => "hide", "id" => "show_event_hidden", "data-post-editable" => "1", "title" => lang('event_details'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#event-calendar").fullCalendar({
            ...
            events: "<?php echo_uri("global_planner/calendar_events"); ?>",
