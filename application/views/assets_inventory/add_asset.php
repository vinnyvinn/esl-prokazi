...
<div class="panel panel-default text-center">
   ...
   <a href="<?php echo base_url('inventory_assets/print_form/'.$id);?>" class="btn btn-success"><i class="fa fa-print" aria-hidden="true"></i>Print</a>
	</div>
		    <b>Asset Form</b>
...
If the items are lost, the cost of the assets will be recovered from your salary at the end of that particular month you reported it lost.</span></p>
		...
		<p>Kindly sign below to acknowledgement receipt of these assets in your possession.</p>
