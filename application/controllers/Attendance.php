...
//        die();
    ...
    function list_data() {
        ...
        $options = array("start_date" => $start_date, "end_date" => $end_date, "login_user_id" => $this->login_user->id);
    ...
    private function _make_row($data) {
        $image_url = isset($data->created_by_avatar) ? get_avatar($data->created_by_avatar) : '';
