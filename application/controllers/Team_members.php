    ...
    private function can_view_team_members_contact_info()
    {
        if ($this->login_user->user_type == "staff") {
            if ($this->login_user->is_admin) {
                ...
                if (get_array_value($this->login_user->permissions, "can_view_team_members_contact_info") == "1" || get_array_value($this->login_user->user_permissions, "can_view_team_members_contact_info") == "1") {
                    return true;
                }
            }
        }
    ...
    private function can_view_team_members_social_links()
    {
        if ($this->login_user->user_type == "staff") {
            if ($this->login_user->is_admin) {
                ...
                if (get_array_value($this->login_user->permissions, "can_view_team_members_social_links") == "1" || get_array_value($this->login_user->user_permissions, "can_view_team_members_social_links") == "1") {
                    return true;
                }
            }
        }
