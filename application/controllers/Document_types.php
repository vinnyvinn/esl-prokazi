...
class Document_types extends Pre_loader
{
    ...
    private function _make_row($data,$key) {
        $optoins = "";
        if (get_array_value($this->login_user->permissions,'can_edit_legal_document_types') ==1 || get_array_value($this->login_user->user_permissions,'can_edit_legal_document_types') ==1) {
        ...
        if (get_array_value($this->login_user->permissions,'can_delete_legal_document_types') ==1 || get_array_value($this->login_user->user_permissions,'can_delete_legal_document_types') ==1) {
