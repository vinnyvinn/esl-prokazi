...
//        die();
        ...
        //initialize login users access permissions
        if ($this->login_user->user_permissions) {
            $user_permissions = unserialize($this->login_user->user_permissions);
            $this->login_user->user_permissions = is_array($user_permissions) ? $user_permissions : array();
        } else {
            $this->login_user->user_permissions = array();
        }
