...
class Trimmer_sheets extends Pre_loader
{
    ...
    public function index()
    {
        ...
        $view_data['trimmer_sheets'] = $this->db->query("SELECT trimmer_sheets.*,trimmers.name as trimmer,sage_projects.name as project FROM trimmer_sheets
    LEFT JOIN trimmers ON trimmers.id=trimmer_sheets.trimmer
    LEFT JOIN sage_projects ON sage_projects.id=trimmer_sheets.project_id")->result_array();
